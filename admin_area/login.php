...
<head>
    ...
    <style>
        body{
            background-image:url(admin_images/logo1.jpg);
...
<body>
   ...
   <div class="container">
       <form action="" class="form-login" method="post">
           ...
           <button type="submit" class="submit-btn" name="admin_login">
...
<?php 
    ...
    if(isset($_POST['admin_login'])){
        ...
        if($count==1){
            ...
            echo "<script>alert('Logged in. Admin Page')</script>";
